...
``` bash
# clone the repo
$ git clone https://github.com/thaihuynhatquang/sguet.git sguet
...
```
### Basic usage
Update file host with [sguet.com](sguet.com)

``` bash
# dev server with hot reload at http://sguet.com
$ yarn start
```

Navigate to [http://sguet.com:3000](http://sguet.com:3000). The app will automatically reload if you change any of the source files.
